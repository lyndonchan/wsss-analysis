...
TRAIN_CUES_ROOT = os.path.join(config['Download Directory']['data_dir'], config['Data Folders']['cues_dir'])
LOG_ROOT = './log'
CKPT_ROOT = './ckpt'
OUT_ROOT = './out'
EVAL_CUES_ROOT = './eval'
...
def gen_cues_adp(model_type, thresh, batch_size, size, cues_dir, set_name, is_verbose):
    ...
    if is_wpt:
        ...
        pt_str = '_npt'
    ac = ADPCues('ADP_' + model_type + pt_str, batch_size, size, model_dir=MODEL_ROOT, data_dir=DATA_ROOT,
