...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_list", default='train75.txt', type=str)
    parser.add_argument("--eval_list", default='test.txt', type=str)
    parser.add_argument("--out", default="cls_labels_unbalanced.npy", type=str)
    ...
    train_label_list = dataloader.load_image_label_list_from_csv(train_name_list, args.root, 'train75.csv')
