...
class AffinityDisplacementLoss(Net):
    ...
    def __init__(self, path_index, model_dir, num_classes):

        super(AffinityDisplacementLoss, self).__init__(model_dir, num_classes)
...
class EdgeDisplacement(Net):
    ...
    def __init__(self, model_dir, num_classes, crop_size=512, stride=4):
        super(EdgeDisplacement, self).__init__(model_dir, num_classes)
